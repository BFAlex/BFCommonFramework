...
{
    return [BFEncryption rbwpEncrypt:aInput Key:@"22690dfba7ab83b4"];
}
+(NSData*)rbwpDecrypt:(NSData*)aInput
{
    NSString *  encryptStr = [[NSString alloc] initWithData:aInput encoding:NSUTF8StringEncoding];
    NSString *  decryStr = [BFEncryption rbwpDecrypt:encryptStr Key:@"22690dfba7ab83b4"];
 ...
 *  @return
 */
+(NSString*)rbwpEncrypt:(NSString*)aInput Key:(NSString*)aKey
{
    NSData* initData = [aInput dataUsingEncoding:NSUTF8StringEncoding];
    NSData * rc4 = [BFEncryption RC4Encrypt:initData withKey:aKey];
 ...
 *  @return
 */
+(NSString*)rbwpDecrypt:(NSString*)aInput Key:(NSString*)aKey
{
    NSData *decodedData = [[NSData alloc] initWithBase64EncodedString:aInput options:0];
    NSData * rc4Data = [BFEncryption RC4Decrypt:decodedData withKey:aKey];
